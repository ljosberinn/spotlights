...
L.Settings.TabPosition = "Posição"
...
"O rastreamento de auras é um recurso exclusivo de Evocador para Sentir Poder e Presciência."
...
L.Settings.AuraWidthPct = "Largura (do quadro)"
L.Settings.AuraHeightPct = "Altura (do quadro)"
